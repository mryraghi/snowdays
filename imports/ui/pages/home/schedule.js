...
Template.HomeSchedule.onCreated(function () {
  let template = Template.instance();
  template.day1 = new ReactiveVar([]);
  template.day2 = new ReactiveVar([]);
  template.day3 = new ReactiveVar([]);
});
...
Template.HomeSchedule.helpers({
  day1: function () {
    return Template.instance().day1.get()
  },
  day2: function () {
    return Template.instance().day2.get()
  },
  day3: function () {
    return Template.instance().day3.get()
  }
});
  ...
  $(document).ready(function () {
    ...
    SchedulePlan.prototype.closeModal = function (event) {
      ...
      if (mq == 'mobile') {
        ...
        let modalTop = Number(self.modal.css('top').replace('px', '')),
    ...
    SchedulePlan.prototype.checkEventModal = function (device) {
      ...
      if (mq == 'mobile') {
        ...
        self.modal.addClass('no-transition');
        self.element.addClass('animation-completed');
        let event = self.eventsGroup.find('.selected-event');
